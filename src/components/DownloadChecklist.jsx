...
const DownloadChecklist = ({ webhook, apiKey, checklistName }) => {
  ...
  return (
    <>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-xs flex items-center justify-center z-20">
          <div className="bg-white p-12 max-w-md m-4 text-black relative rounded-md">
            ...
            <button
              className="bg-mariner-600 p-1 rounded-full absolute top-2 right-2 cursor-pointer"
              onClick={() => {
                toggleModal();
                document.body.style.overflow = "auto";
              }}
